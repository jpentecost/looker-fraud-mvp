view: dimcustomer {
  ...
  dimension: applicationchannel {
    type: string
    sql: ${TABLE}.applicationchannel ;;
  }
  ...
  dimension: isfraudrestricted {
    type: string
    sql: ${TABLE}.isfraudrestricted ;;
  }
  ...
  dimension: isoutbound {
    type: string
    sql: ${TABLE}.isoutbound ;;
  }
